 ...
 * Section : BSIT 2-1
 * Actvity: Performance Task #3 - Hybrid Quicksort
 * Date : November 24, 2022
*/
import java.util.Arrays;
import java.util.Scanner;
 
public class HybridQuickwithInsert
{
    ...
    public static void main(String[] args)
    {
        ...
        // perform Quicksort NUM times and take an average of time in nanosec
        for (int i = 0; i < NUM; i++)
        {            
        ...
        // perform Hybrid Quicksort NUM times and take an average of time in nanosec
        for (int i = 0; i < NUM; i++)
        {            
